/**
 * timeout.const.ts: This module provides Timeout constants that can be used to override various actions, conditional statements and assertions.
 ...
 */
export const INSTANT_TIMEOUT = 1 * 1000;
 ...
 */
export const MAX_TIMEOUT = 1 * 60 * 1000;
